...
load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesPsi1.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesPsi2.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesPsi3.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesGamma1.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesGamma2.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesPhi1.rda"))

load(file = paste0("../ModelBuild/GlobalModel/", version, "/MCMCsamplesPhi2.rda"))
