...
save(MCMCsamplesBDPhi, file = paste0("/Users/coldwater/Documents/Projects/SalixStressVigor/ModelBuild/GlobalModel/", version, "/MCMCsamplesBDPhi.rda"))
