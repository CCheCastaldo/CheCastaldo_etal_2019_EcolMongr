...
4. `StemBiomass` contains the R script for the model of willow stem biomass as a function of willow basal stem diameter used to estimate the scaling coefficient $n_{1}$. 
...
```{r, echo = FALSE}
load(file = "Library/transectPoints.rda")
...
```{r, echo = FALSE}
load(file = "Library/soilReleaseCurve.rda")
